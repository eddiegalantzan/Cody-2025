...
**User Roles:** The application implements a role-based access control (RBAC) system with four organization roles: `owner`, `admin`, `member`, and `viewer`. See [README.md](../README.md#user-roles) for detailed role permissions and capabilities.
