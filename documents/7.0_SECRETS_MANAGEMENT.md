...
# WCO (WORLD CUSTOMS ORGANIZATION) CREDENTIALS
# See: https://www.wcoomd.org/
# Used for accessing WCO Trade Tools, data downloads, and API access
WCO_USERNAME=your_wco_username_here
WCO_PASSWORD=your_wco_password_here
```
