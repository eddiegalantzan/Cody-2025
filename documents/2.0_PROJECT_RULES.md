...
- **📖 Detailed Guide:** [4.0_WRAPPERS_GUIDE.md](./4.0_WRAPPERS_GUIDE.md)
...
- Use project's logger (e.g., `electron-log` via wrapper) for logging
...
- **ESLint:** TypeScript plugin; pre‑commit `yarn lint`
...
- For complex algorithms, include `README.md` alongside component explaining rationale, approach, and trade‑offs
